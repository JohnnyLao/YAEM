...
@extend_schema_view(
    ...
    create=extend_schema(
        summary="Create a new user's payment", tags=["Users: Payments"]
    ),
)
class PaymentView(ListAPIView, CreateAPIView, GenericAPIView):
    ...
    def list(self, request, *args, **kwargs):
        ...
        if current_user.is_authenticated:
            # Get all user's payments, filtered by client-user
